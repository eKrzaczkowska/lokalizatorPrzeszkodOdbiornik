...
void nRF_Set_Active_DataPipe_And_ACK (uint8_t DataPipe, uint8_t on_or_off, uint8_t ACK_on_or_off );					 //This function is used to set active payload/payloads and enable/disable ACK functions
 													 //this function is used to set payload length. Use this function if dynamic payload length is disabled
...
void nRF_RX_EVENT (void)
{
	...
	if ( RX_flag )								//je¿eli zmienna RX_flag == 1 to:


	{	
		wdt_reset(); //watchdog resetowanie
		...
		//do...while loop until RX_FIFO is empty
		...
		do
		{
			...
			if ( len &&  nRF_RX_Event_Callback ) ( * nRF_RX_Event_Callback )( nRF_RX_bufffer, len ); 
			//if callback function is registered and len is bigger	 //than 0 send recived data to your callback function
		}
...
void nRF_init( void )
{
	...
	nRF_Set_Data_Speed_And_Reciver_Power(TRANS_SPEED_250kB, RF_PWR_0dB );     //Set transmision speed and reciver power
...
uint8_t i;
	for(i = 0; i < TX_ADDRES_LENGTH; i++ )                                          //until i is smaller than TX_ADDRES LENGTH copy data from flash to temporary TX_addres buffer
	{
...
void Initialize_INTERRUPT_For_nRF(void)
{
	...
	MCUCR |= (1<<ISC01);              //set active on falling edge
}

//'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
// Here is external intterupt handler, if you are using interupts change the name of the vector interrupt or live the same if you are using the same
//...................................................................................................................................................
ISR(INT0_vect)
{
	CSN_LOW;											//Chip select LOW
